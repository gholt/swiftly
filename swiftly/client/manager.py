"""
Contains ClientManager and IOManager classes that can be used to
manage resources.
"""
"""
...
class ClientManager(object):
    """
    Is constructed exactly like :py:class:`swiftly.client.Client` and
    is then used to construct actual clients as needed.
    """
    ...
    def __init__(self, auth_url=None, auth_user=None, auth_key=None,
        ...
        self.swift_proxy_storage_path = swift_proxy_storage_path
        self.cache_path = cache_path
        self.eventlet = eventlet
        self.swift_proxy_cdn_path = swift_proxy_cdn_path
        self.region = region
    ...
    def get_client(self):
        """
        Obtains a :py:class:`swiftly.client.Client` for use, whether
        an existing unused client or a brand new one if none are
        available.
        """
        client = None
        try:
        ...
        if not client:
            ...
            client = swiftly.client.Client(
                ...
                swift_proxy=self.swift_proxy,
                swift_proxy_storage_path=self.swift_proxy_storage_path,
                cache_path=self.cache_path,
                eventlet=self.eventlet,
                swift_proxy_cdn_path=self.swift_proxy_cdn_path,
                region=self.region,
                verbose=self.verbose,
                verbose_id=self.verbose_id + str(self.client_id),
                auth_tenant=self.auth_tenant,
    ...
    def with_client(self):
        """
        A context manager that obtains a
        :py:class:`swiftly.client.Client` for use, whether an
